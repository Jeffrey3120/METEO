...
map.on("click", async function (e) {
  ...
  let temperatura =
    datiMeteo.current_weather &&
    datiMeteo.current_weather.temperature !== undefined
      ? datiMeteo.current_weather.temperature
      : null;
